function Section = CalculateShearResistance_LRFR(Section,panel,location)

% Define Variables
dw = Section.dw;
tw = Section.tw;
tf_top  = Section.tf_top(1);
bf_top  = Section.bf_top(1);
tf_bottom = Section.tf_bottom(1);
bf_bottom = Section.bf_bottom(1);
E = Section.Es;
Fy = Section.Fy;
Lb = Section.Lb;
